    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <h3 class="animated fadeInLeft">Примеры работ малых архитектурных форм</h3>
                </div>
        ...
        <div class="col-md-12 top-20 padding-0">
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading"><h3>Примеры работ малых архитектурных форм</h3></div>
                    <div class="panel-body">
