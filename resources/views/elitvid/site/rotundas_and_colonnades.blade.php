        ...
        <section class="main">
            <div class="description">
                <div class="description-text">
                    <h1>Ротонды<br> и коллонады</h1>
                    <p>Ротонда -  это разновидность достаточно крупных и заметных малых архитектурных форм, которые служат местом для приятного времяпрепровождения. Всегда имеет круглую форму, колоннаду и купол.
                        <br><br>Беседка – ротонда является эксклюзивных элементом оформления садов и парков. Дополнив её скамейками, Вы получаете место для комфортного отдыха.</p>
                </div>
            ...
            <div class="stages">
                <div class="image">
                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/rotundas/rotundas.png')}}" alt="Фотография три кашпо в ряд"
                         class="main-page-up">
                </div>
