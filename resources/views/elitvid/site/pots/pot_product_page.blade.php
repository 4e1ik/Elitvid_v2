...
{{--                                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-porous.png')}}" alt="">--}}
{{--                                    <p>Пористая</p>--}}
{{--                                    <img class="texture_popup__image" src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-porous.png')}}"--}}
{{--                                         alt="">--}}
{{--                                    <p class="texture_popup__text">Пористая</p>--}}
{{--                                </div>--}}
{{--                                <div class="image_texture">--}}
{{--                                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-smooth.png')}}" alt="">--}}
{{--                                    <p>Гладкая</p>--}}
{{--                                    <img class="texture_popup__image" src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-smooth.png')}}"--}}
{{--                                         alt="">--}}
{{--                                    <p class="texture_popup__text">Гладкая</p>--}}
{{--                                </div>--}}
{{--                                <div class="image_texture">--}}
{{--                                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-marble.png')}}" alt="">--}}
{{--                                    <p>Мрамор</p>--}}
{{--                                    <img class="texture_popup__image" src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-marble.png')}}"--}}
{{--                                         alt="">--}}
...
{{--                                <div class="image_texture">--}}
{{--                                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-blitz.png')}}" alt="">--}}
{{--                                    <p>Блиц</p>--}}
{{--                                    <img class="texture_popup__image" src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-blitz.png')}}"--}}
{{--                                         alt="">--}}
{{--                                    <p class="texture_popup__text">Блиц</p>--}}
{{--                                </div>--}}
{{--                                <div class="image_texture">--}}
{{--                                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-wild_stone.png')}}" alt="">--}}
{{--                                    <p>Дикий камень</p>--}}
{{--                                    <img class="texture_popup__image" src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pots/textures/texture-wild_stone.png')}}"--}}
{{--                                         alt="">--}}
