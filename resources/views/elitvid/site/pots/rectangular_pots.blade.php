...
<main>
    ...
    <section class="main">
        ...
        <div class="stages">
            <div class="image">
                <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/rectangular_pots.webp')}}" alt="{{$static_images_arr['/elitvid_assets/newDesign/newDesign/imgs/rectangular_pots.webp'] ?? ''}}"
        ...
        <div class="not_main_page directions">
            @foreach($products as $product)
                <div class="direction">
                    ...
                    <a href="{{route('show_pot_product', ['collection' => 'rectangular_pots', 'slug' => $product->slug])}}">
