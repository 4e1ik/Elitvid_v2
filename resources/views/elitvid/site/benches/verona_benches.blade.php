        ...
        <section class="main">
            <div class="description">
                <div class="description-text">
                    ...
                    <p>Коллекция с потрясающими природными формами, гармонично впишется в любой ландшафт. Включает в себя
                        кашпо и мебель.</p>
                </div>
            ...
            <div class="stages">
                <div class="image">
                    <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/collections/verona/verona.webp') }}"
                        alt="{{ $static_images_arr['/elitvid_assets/newDesign/newDesign/imgs/benches/collections/verona/verona.webp'] ?? '' }}"
