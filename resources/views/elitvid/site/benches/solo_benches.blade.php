...
@section('content')
    <main>
        ...
        <section class="main">
            ...
            <div class="stages">
                <div class="image">
                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/benches/collections/solo/solo.png')}}"
                         alt="{{$static_images_arr['/elitvid_assets/newDesign/newDesign/imgs/benches/collections/solo/solo.png']}}"
                         class="main-page-up">
                </div>
            ...
            <div class="not_main_page directions">
                @foreach($products as $product)
                    <div class="direction">
                        ...
                        <a href="{{route('show_bench_product', ['collection' => 'solo_benches', 'id' => $product->id])}}">
