...
@section('content')
    <main>
        ...
        <section class="product">
            ...
            <h1 style="font-size: 2.25em; font-family:'Merriweather'; text-transform: uppercase; font-weight: 300;">
                {{ $product->name }}</h1>
                    ...
                    <div class="content_images__colors">
                        ...
                        <div class="images_colors__images">
                            <div data-color="grey" data-title="Серый бетон" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/grey_concrete_color.webp') }}"
                            ...
                            <div data-color="graphite" data-title="Графит" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/graphite_color.webp') }}"
                            ...
                            <div data-color="black" data-title="Черный" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/black_color.webp') }}"
                            ...
                            <div data-color="white" data-title="Белый" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/white_color.webp') }}"
                            ...
                            <div data-color="ivory" data-title="Слоновая кость" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/ivory_color.webp') }}"
                            ...
                            <div data-color="sand" data-title="Песочный" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/sand_color.webp') }}"
                            ...
                            <div data-color="orange" data-title="Оранжевый" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/orange_color.webp') }}"
                            ...
                            <div data-color="olive" data-title="Оливка" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/olive_color.webp') }}"
                            ...
                            <div data-color="malachite" data-title="Малахит" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/malachite_color.webp') }}"
                            ...
                            <div data-color="white_blue" data-title="Голубой" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/white-blue_color.webp') }}"
                            ...
                            <div data-color="blue" data-title="Синий" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/blue_color.webp') }}"
                            ...
                            <div data-color="bronze" data-title="Бронза" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/pots/colors/bronze_color.webp') }}"
                    ...
                    <div class="content_images__colors content_images_boards-colors--mobile">
                        ...
                        <div class="images_colors__images images_color-boards__images">
                            <div data-title="Белый" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/white.webp') }}"
                            ...
                            <div data-title="Серый" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/grey.webp') }}"
                            ...
                            <div data-title="Бесцветный" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/no_color.webp') }}"
                            ...
                            <div data-title="Сосна" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/pine.webp') }}"
                            ...
                            <div data-title="Тик" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/teak.webp') }}"
                            ...
                            <div data-title="Мерабу" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/merabu.webp') }}"
                            ...
                            <div data-title="Дуб" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/oak.webp') }}"
                            ...
                            <div data-title="Палисандр" class="image_color">
                                <img src="{{ asset('/elitvid_assets/newDesign/newDesign/imgs/benches/colors/rosewood.webp') }}"
                            ...
                            <div class="swiper-slide">
                                <div class="direction">
                                    <a href="{{ route('show_bench_product', [
                                        ...
                                        <img src="{{ asset('storage/' . str_replace('public/', '', $rand_product->images->first()->image)) }}"
                                            alt="{{ $rand_product->images->first()?->description_image ?? '' }}"
                                            loading="lazy">
                                        <button type="button">{{ $rand_product->name }}</button>
                                    </a>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="swiper-button-prev arrow-left arrow">
                        <svg width="12" height="18" viewBox="0 0 12 18" fill="none"
                            ...
                            <path id="Line 1" d="M9.54419 1.5L2.45559 9L9.54419 16.5" stroke="white"
                                stroke-width="2.99575" stroke-linecap="round" />
                        </svg>
                    </div>
