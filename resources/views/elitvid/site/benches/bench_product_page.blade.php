    ...
    <main>
        ...
        <section class="breadcrumbs">
            <div class="breadcrumbs__links">
                ...
                <a href="{{route($product->collection == 'Verona' ?
                    'verona_benches':($product->collection == 'Stones' ?
                        'stones_benches': ($product->collection == 'lines' ?
                            'lines_benches' : ($product->collection == 'Solo' ?
                                'solo_benches' : ($product->collection == 'Street_furniture' ?
                                    'street_furniture_benches': '')))))}}">
                                    {{ $product->collection == 'Verona' ?
                                    'Коллекция Verona':($product->collection == 'Stones' ?
                                        'Коллекция Stones': ($product->collection == 'lines' ?
                                            'Коллекция Lines' : ($product->collection == 'Solo' ?
                                                'Коллекция Solo' : ($product->collection == 'Street_furniture' ?
                    ...
                    <div class="product_content__images">
                        ...
                        <div class="content_images__main-image">
                            <img src="{{asset('storage/'.str_replace('public/','',$product->bench_images[0]->image))}}"
                                 alt="{{$product->bench_images[0]->description_image}}">
                            {{--                            <img id="image" src="{{asset('storage/images/'.$product->name)}}" alt="{{$static_images_arr[]}}">--}}
                        </div>
                        ...
                        @foreach($rand_products->where('collection', $product->collection) as $rand_product)
                            <div class="swiper-slide">
                                <div class="direction">
                                    ...
                                    <a href="{{route('show_bench_product', ['collection' => ($product->collection == 'Verona' ?
                                                                                'verona_benches':($product->collection == 'Stones' ?
                                                                                    'stones_benches': ($product->collection == 'lines' ?
                                                                                        'lines_benches' : ($product->collection == 'Solo' ?
                                                                                            'solo_benches' : ($product->collection == 'Street_furniture' ?
