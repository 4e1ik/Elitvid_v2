...
@section('content')
    <main>
        ...
        <section class="main">
            ...
            <div class="stages">
                <div class="image">
                    <img src="{{asset('/elitvid_assets/newDesign/newDesign/imgs/pillars/pillars.png')}}" alt="{{$static_images_arr['/elitvid_assets/newDesign/newDesign/imgs/pillars/pillars.png']}}"
                         class="main-page-up">
                </div>
