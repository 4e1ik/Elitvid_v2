{{-- Форма для редактирования скамеек --}}
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-body" id="panel-body">
                ...
                @php
                    $oldData = old('data', $product->bench->data ?? [['size' => '', 'weight' => '', 'price' => '']]);
                ...
                <div class="col-md-12">
                    <div class="col-md-3 padding-0">
                        ...
                        <select class="form-control" name="collection" id="">
                            ...
                            <option {{ ($errors->has('collection') ? old('collection') : $product->bench->collection) == 'lines' ? 'selected' : ''}} value="lines">Коллекция lines</option>
                            <option {{ ($errors->has('collection') ? old('collection') : $product->bench->collection) == 'Solo' ? 'selected' : ''}} value="Solo">Коллекция Solo</option>
