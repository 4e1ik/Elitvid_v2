                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <div class="col-md-3">
{{--                                <form--}}
{{--                                    action="{{ route('pot_image_destroy', ['blog' => $blog]) }}"--}}
{{--                                    method="post">--}}
{{--                                    @method('DELETE')--}}
{{--                                    @csrf--}}
                                ...
                                <div class="col-md-3 padding-0">
                                    ...
                                    <div class="col-md-11 padding-0">
                                        <input class="form-control {{$errors->has('title') ? 'danger' : ''}}"
                                               type="text"
                                               name="title" value="{{$errors->has('title') ? old('title') : $blog->title}}">
                                    </div>
                                    @error('title')
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <textarea class="textarea form-control {{$errors->has('description') ? 'danger' : ''}}" name="description" style="width: 100%;" rows="10" type="text"
                                      placeholder="@error('description') {{$message}} @enderror">{{$errors->has('description') ? old('description') : $blog->description}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-3 padding-0">
                                    ...
                                    <div class="col-md-11 padding-0">
                                        <input class="form-control {{$errors->has('meta_title') ? 'danger' : ''}}"
                                               type="text"
                                               name="meta_title" value="{{$errors->has('meta_title') ? old('meta_title') : $blog->meta_title}}">
                                    </div>
                                    @error('meta_title')
                                    <div class="text-danger">
                                        {{$message}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8 padding-0">
                                            ...
                                            <textarea name="meta_description" style="width: 100%;" rows="10" type="text"
                                                      placeholder="Введите описание товара">{{$errors->has('meta_description') ? old('meta_description') : $blog->meta_description}}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 padding-0">
                                    ...
                                    <textarea id="editor" rows="25" style="width: 100%" name="content">
                                        {{$errors->has('content') ? old('content') : $blog->content}}
                                    </textarea>
                                    <script>
                                        tinymce.init({
                                            selector: '#editor',
