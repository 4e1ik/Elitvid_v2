...
class CreateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'variants.*.weight' => 'nullable|max:50',
            'variants.*.price' => 'nullable|max:50',
    ...
    public function messages(): array
    {
        return [
            ...
            'variants.array' => 'Варианты должны быть массивом.',
            'variants.min' => 'Необходимо добавить хотя бы один вариант товара.',
            'variants.*.size.max' => 'Размер не должен превышать :max символов.',
            'variants.*.weight.max' => 'Вес не должен превышать :max символов.',
            'variants.*.price.max' => 'Цена не должна превышать :max символов.',
