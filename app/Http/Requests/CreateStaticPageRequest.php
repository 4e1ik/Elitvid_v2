...
class CreateStaticPageRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'main_image.mimetypes' => 'Главная картинка должна быть в формате: jpeg, jpg, png или webp.',
            ...
            'menu_image.mimetypes' => 'Картинка меню должна быть в формате: jpeg, jpg, png или webp.',
