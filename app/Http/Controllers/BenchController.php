...
class BenchController
{
    ...
    function benches() {
        ...
        return view('elitvid.site.benches', compact('benches_images', 'pageContent', 'static_images_arr', 'static_pages'));
    }
    ...
    function street_furniture_benches() {
        ...
        return view('elitvid.site.benches.street_furniture_benches', compact('products', 'pageContent', 'static_images_arr', 'static_pages'));
    }
    ...
    function verona_benches() {
        ...
        return view('elitvid.site.benches.verona_benches', compact('products', 'pageContent', 'static_images_arr', 'static_pages'));
    }
    ...
    function stones_benches() {
        ...
        return view('elitvid.site.benches.stones_benches', compact('products', 'pageContent', 'static_images_arr', 'static_pages'));
    }
    ...
    function solo_benches() {
        ...
        return view('elitvid.site.benches.solo_benches', compact('products', 'pageContent', 'static_images_arr', 'static_pages'));
    }
    ...
    function lines_benches() {
        ...
        return view('elitvid.site.benches.lines_benches', compact('products', 'pageContent', 'static_images_arr', 'static_pages'));
    }
